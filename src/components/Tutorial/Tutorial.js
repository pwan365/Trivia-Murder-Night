        ...
        <div>
            ...
            <div className="tut-flex">
                <div className="tutorial-container">
                    ...
                    <Typography variant="h5" className="tutorial-text">Scroll down in the home page to reveal the button</Typography>
                    ...
                    <img className="tutorial-img" src={Img2} />
                    ...
                    <img className="tutorial-img" src={Img3} />
                ...
                <div className="tutorial-container">
                    ...
                    <img className="tutorial-img" src={Img10} />
                    ...
                    <img className="tutorial-img" src={Img11} />
